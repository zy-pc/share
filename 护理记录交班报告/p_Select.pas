...
begin
for i:=0 to chkb1.items.count-1 do
 if (select_grideh.columns[i].title.Caption='时间') or (select_grideh.columns[i].title.Caption='血压(mmHg)') or (select_grideh.columns[i].title.Caption='血糖(mmol/L)') or (select_grideh.columns[i].title.Caption='护士签名')then
     begin
