...
begin
  ...
  begin
    ...
    begin
      ...
      QRLabel50.Caption := '病床号:' + sp_jbxx.fieldbyname( 'bch' ).asstring;
      ...
      QRLabel67.Caption:='姓名:' + sp_jbxx.fieldbyname( 'brxm' ).asstring+'      '+
                         '病床号:' + sp_jbxx.fieldbyname( 'bch' ).asstring+'      '+
...
begin
  ...
  begin
    ...
    begin
      ...
      QRLabel20.Caption := '病床号:' + sp_jbxx.fieldbyname( 'bch' ).asstring;
...
begin
  ...
  begin
    ...
    begin
      ...
      QRLabel36.Caption := '床号:' + sp_jbxx.fieldbyname( 'bch' ).asstring;
      ...
      qrl_ks.Caption:= '姓名:' + sp_jbxx.fieldbyname( 'brxm' ).asstring+'   '+
                       '床号:' + sp_jbxx.fieldbyname( 'bch' ).asstring+'   '+
                       '病区:' + pub_bqmc;
      QuickRep4.Preview;
    end;
  end;
