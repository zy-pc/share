object frm_hyjk: Tfrm_hyjk
  Left = 190
  Top = 123
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  BorderWidth = 4
  Caption = #24314#21345#30331#35760'/'#20462#25913
  ClientHeight = 531
  ClientWidth = 680
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object khlb: TComboBox
      ...
      TabOrder = 9
      OnExit = khlbExit
      OnKeyPress = khlbKeyPress
    end
    object brxx: TComboBox
      Left = 308
      Top = 97
      Width = 120
      Height = 24
    ...
    object csrq: TcxDBDateEdit
      Left = 535
      Top = 11
      DataBinding.DataField = 'csrq'
      DataBinding.DataSource = ds_dj
      TabOrder = 2
      OnEnter = csrqEnter
      OnExit = csrqExit
      OnKeyPress = csrqKeyPress
      Width = 131
    end
    object nl: TSXAgeBox
      Left = 74
      ...
      OnEnter = nlEnter
      OnExit = nlExit
      OnKeyPress = nlKeyPress
    end
    object sbzl: TComboBox
      Left = 74
      Top = 155
      Width = 120
      Height = 23
      ...
      TabOrder = 21
      OnExit = sbzlExit
      OnKeyPress = sbzlKeyPress
    end
    object brdw: TComboBox
      Left = 535
      Top = 219
      Width = 131
      Height = 24
  ...
  object Panel2: TPanel
    ...
    object Label26: TLabel
      ...
      Width = 64
      Height = 16
      Caption = #36139#22256#20154#21475
      Visible = False
    end
    object tmh: TEdit
      Left = 253
      ...
      Width = 176
      Height = 29
      Hint = #36755#20837#21345#21495#65306
      Font.Charset = GB2312_CHARSET
      Font.Color = clBlue
      Font.Height = -21
      Font.Name = #23435#20307
  ...
  object pnl2: TPanel
    ...
    object edt_sjsysl: TEdit
      ...
      ReadOnly = True
      TabOrder = 3
      Text = #21097#20313':0'#24352
    end
    object edtczyxm: TEdit
      Left = 193
      Top = 5
      Width = 102
      Height = 24
  ...
  object qry_sblb: TADOQuery
    Connection = DM_data.ado_mydata
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select * from zysf_sbbrlb')
    Left = 501
    Top = 340
  end
  object ds_sblb: TDataSource
    DataSet = qry_sblb
    Left = 193
    Top = 339
  end
  object qry_kgl: TADOQuery
    Connection = DM_data.ado_mydata
    CursorType = ctStatic
    Parameters = <>
    Left = 549
  ...
  object qry_dw: TADOQuery
    ...
    SQL.Strings = (
      'declare @pym varchar(20)'
      'select @pym=:pym'
      'select @pym='#39'%'#39'+@pym+'#39'%'#39
      'select * '
      'from sys_tjdw '
      
        'where  convert(varchar(8),jzrq,112)>=convert(varchar(8),getdate(' +
        '),112)   and qybz=1'
      
        '            and (pym like  @pym  or dwmc like  @pym  or  cast(dw' +
        'id as varchar) like  @pym  )')
    Left = 416
    Top = 393
  end
  ...
  object qry_pkrk: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select * from  sys_pkrkxx where sfzh=:sfzh and  isnull(sfzh,'#39#39')<' +
        '>'#39#39)
    Left = 520
    Top = 393
  end
  object ds_yyjk: TADODataSet
    Connection = DM_data.ado_mydata
    CommandText = 'select * from PatientInfo where 1<>1'
    Parameters = <>
    Left = 96
    Top = 392
  end
  ...
  object sp_sclsh: TADOStoredProc
    Connection = DM_data.ado_mydata
    ProcedureName = 'p_c_RecordFlow'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
