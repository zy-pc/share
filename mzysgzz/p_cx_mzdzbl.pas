...
procedure Tfrm_cx_mzdzbl.BBtn_cxClick(Sender: TObject);
...
procedure Tfrm_cx_mzdzbl.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure Tfrm_cx_mzdzbl.DBGridEh1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then
    if qry_bl_list.Active then
...
procedure Tfrm_cx_mzdzbl.DBGridEh2DblClick(Sender: TObject);
begin
  Proc_Selected_br;
end;

procedure Tfrm_cx_mzdzbl.DBGridEh2Exit(Sender: TObject);
begin
  DBGrideh2.Visible := False;
end;

procedure Tfrm_cx_mzdzbl.DBGridEh2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then
    Proc_Selected_br;
...
procedure Tfrm_cx_mzdzbl.DBLookupComboBox1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then
    edt_bllb.SetFocus;
...
procedure Tfrm_cx_mzdzbl.edt_bllbKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key = 13 then
  begin
...
procedure Tfrm_cx_mzdzbl.edt_tmhKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var v_txt: string;
begin
  if key = 13 then
...
procedure Tfrm_cx_mzdzbl.FormShow(Sender: TObject);
begin
  PageControl1.ActivePage := tab_blnr;
...
procedure Tfrm_cx_mzdzbl.N1Click(Sender: TObject);
begin
  EMRPad301.SetDocumentMode(3);
end;

procedure Tfrm_cx_mzdzbl.N2Click(Sender: TObject);
begin
...
procedure Tfrm_cx_mzdzbl.N3Click(Sender: TObject);
begin
  EMRPad301.SetDocumentMode(1);
  EMRPad301.Print(0);
  EMRPad301.SetDocumentMode(2);
...
procedure Tfrm_cx_mzdzbl.N4Click(Sender: TObject);
begin
  EMRPad301.SetDocumentMode(1);
  EMRPad301.Print(2);
  EMRPad301.SetDocumentMode(2);
...
procedure Tfrm_cx_mzdzbl.N5Click(Sender: TObject);
begin
  EMRPad301.SetDocumentMode(1);
  EMRPad301.Print(1);
  EMRPad301.SetDocumentMode(2);
...
procedure Tfrm_cx_mzdzbl.N6Click(Sender: TObject);
begin
  EMRPad301.SetDocumentMode(1);
  EMRPad301.PageSetup;
  EMRPad301.SetDocumentMode(2);
...
procedure Tfrm_cx_mzdzbl.N8Click(Sender: TObject);
begin
  EMRPad301.SetDocumentMode(1);
...
procedure Tfrm_cx_mzdzbl.Proc_CreateTree;
const
  ID_DEPT = 3;
var
  nLevel: Integer;
...
procedure Tfrm_cx_mzdzbl.Proc_Seek_brbl(const v_zyh, v_blid, v_fldm: string);
...
procedure Tfrm_cx_mzdzbl.Proc_Selected_br;
begin
  edt_tmh.Text := qry_dj.FieldByName('tmh').AsString;
  DBLookupComboBox1.SetFocus;
end;

procedure Tfrm_cx_mzdzbl.SpeedButton1Click(Sender: TObject);
begin
  treeview.Visible := True;
  treeview.SetFocus;
end;

procedure Tfrm_cx_mzdzbl.treeviewDblClick(Sender: TObject);
var v_str: string;
begin
...
procedure Tfrm_cx_mzdzbl.treeviewExit(Sender: TObject);
begin
  treeview.Visible := False;
end;

procedure Tfrm_cx_mzdzbl.treeviewKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var v_str: string;
begin
  if key = 13 then
