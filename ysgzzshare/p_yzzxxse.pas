...
begin
  ...
  begin
    ...
    begin
      if Trim(sp_dryz.FieldByName('fzph').AsString) <> '' then
      begin
        _SQl1 := 'update zybl_zyyz set shry=''拒用'',tzbz=1,tzry=' + '''' +
          pub_czydm + '''' + ',tzrq=' + '''' +
...
begin
  ...
  begin
    ...
    begin
      if Trim(sp_dryz.FieldByName('fzph').AsString) <> '' then
      begin
        _SQl1 := 'update zybl_zyyz set shry=''未用'',tzbz=1,tzry=' + '''' +
          pub_czydm + '''' + ',tzrq=' + '''' +
          FormatDateTime('yyyy-MM-dd hh:mm:ss', Frm_func.curr_date) + '''' +
          ' where fzph=' + '''' + trim(sp_dryz.FieldByName('fzph').asstring) +
          '''';
...
begin
  ...
  begin
    ...
    begin
      if Trim(sp_dryz.FieldByName('fzph').AsString) <> '' then
      begin
        _SQl1 := 'update zybl_zyyz set shry=''拒查'',tzbz=1,tzry=' + '''' +
          pub_czydm + '''' + ',tzrq=' + '''' +
          FormatDateTime('yyyy-MM-dd hh:mm:ss', Frm_func.curr_date) + '''' +
          ' where fzph=' + '''' + trim(sp_dryz.FieldByName('fzph').asstring) +
          '''';
