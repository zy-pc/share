...
procedure Tfrm_yzqd.PageFooterBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
paper_size:=0;
end;

procedure Tfrm_yzqd.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     if paper_size>792 then
      begin
        rep_dryphz.NewPage;
        paper_size:=0;
      end;
...
procedure Tfrm_yzqd.QRSubDetail1NeedData(Sender: TObject;
...
procedure Tfrm_yzqd.rep_dryphzBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
sp_yzmx.First;
paper_size:=0;
...
procedure Tfrm_yzqd.Button3Click(Sender: TObject);
begin
  close;
end;
