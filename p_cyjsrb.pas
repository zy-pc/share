...
var
  frm_cyjsrb: Tfrm_cyjsrb;

implementation
uses p_dm, p_func,p_zysf_print_service;
{$R *.DFM}

procedure Tfrm_cyjsrb.FormShow( Sender: TObject );
begin
  dtp1.date := now;
  dtp2.date := now;
...
procedure Tfrm_cyjsrb.N1Click( Sender: TObject );
var
...
procedure Tfrm_cyjsrb.N2Click( Sender: TObject );
begin
  try
    sp_cyjsrb.Filtered := true;
    try
...
procedure Tfrm_cyjsrb.N3Click( Sender: TObject );
begin
  try
    sp_cyjsrb.Filtered := true;
    try
...
procedure Tfrm_cyjsrb.N4Click(Sender: TObject);
begin
...
procedure Tfrm_cyjsrb.QRDBText10Print( sender: TObject; var Value: string );
begin
  if trim( value ) <> '' then
  begin
...
procedure Tfrm_cyjsrb.QRDBText1Print( sender: TObject; var Value: string );
begin
  if trim( value ) <> '' then
  begin
    value := formatdatetime( 'yy-mm-dd', strtodatetime( value ) );
...
procedure Tfrm_cyjsrb.dtp1Change( Sender: TObject );
begin
  sp_cyjsrb.close;
end;

procedure Tfrm_cyjsrb.BitBtn1Click( Sender: TObject );
var
  I: Integer;
...
procedure Tfrm_cyjsrb.BitBtn3Click( Sender: TObject );
begin
  self.close;
end;

procedure Tfrm_cyjsrb.Button1Click(Sender: TObject);
begin
...
procedure Tfrm_cyjsrb.cxgrdbtblvwGrid1DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean );
begin
...
procedure Tfrm_cyjsrb.AdjustPos;
begin
